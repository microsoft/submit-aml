...
def submit(
    ...
    datasets_download: Optional[List[str]] = typer.Option(  # noqa: UP006, UP007
        ...
        help=(
            ...
            " previous job, the preferred form is 'alias=<job_id>:<path>' (the"
            " same as --download-job); for example,"
            " 'checkpoint=crusty_hat_43s6lmvb25:outputs/checkpoint-10000'. The"
            " older 'alias=job_dir:<job_id>:<path>' form is also still accepted."
